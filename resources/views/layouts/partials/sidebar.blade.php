                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar sidebar-item" id="adminSidebar">
                        ...
                        <a href="#" id="bord"
                            ...
                            aria-controls="quest">
                            <i class="bi bi-question-diamond-fill me-2 text-warning" style="margin-left:15px;"></i>Questions
                        </a>
                        ...
                        <a href="#" id="loginLink" style="text-decoration: 0 ; color:whitesmoke; font-size:20px;"
                            class="fw-bold">
                            <i class="bi bi-diagram-2-fill me-2 text-warning" style="font-size:20px;"></i>Role
                        </a>
                        <div id="roleModal" class="modal">
                            <div class="modal-content">
                                ...
                                <div class="d-flex justify-content-between" style="margin-top: 25px;">
                                    <button id="closeModal" class="bg-primary btn-lg"
                                        style="width: 400px; margin-left:8px">Close</button>
                                    <button id="submitRole" class="bg-warning btn-lg"
                                        style="width: 400px ;">Submit</button>
                                </div>
                            </div>
                        </div>
                    </li>
